...
and use them for various tasks in CAD/CAM such as shape decomposition for manufacturing and motion planning (\TODO: Add citations).  Benchmarks and plotting scripts used for the
...
double precision.  This allows use of fast interval arithmetic filters (\TODO: cite), falling back to exact integer evaluation using GMP if the filter fails (\TODO: cite), falling back
